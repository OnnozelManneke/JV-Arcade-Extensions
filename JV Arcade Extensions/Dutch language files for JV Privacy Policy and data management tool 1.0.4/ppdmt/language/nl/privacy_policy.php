...
<h3>Cookies</h3>
De internetpagina’s van de website “%1$s” gebruiken cookies. Cookies zijn tekstbestanden die via een internetbrowser in een computersysteem worden opgeslagen.
...
De voor de verwerking verantwoordelijke verstrekt op elk moment op verzoek informatie aan elke betrokkene over welke persoonsgegevens over de betrokkene zijn opgeslagen. Bovendien corrigeert of wist de voor de verwerking verantwoordelijke persoonsgegevens op verzoek of op aanwijzing van de betrokkene, voor zover er geen wettelijke opslag verplichtingen zijn. Het geheel van de medewerkers van de controller is in dit opzicht beschikbaar voor de betrokkene als contactpersonen.
...
De voor de verwerking verantwoordelijke verwerkt en bewaart de persoonsgegevens van de betrokkene alleen voor de periode die nodig is om het doel van opslag te bereiken, of voor zover dit door de Europese wetgever of andere wetgevers wordt toegestaan in wet of regelgeving waaraan de voor de verwerking verantwoordelijke is naar onderworpen.
...
Als een van de bovengenoemde redenen van toepassing is en een betrokkene om verwijdering van door de website “%1$s” opgeslagen persoonlijke gegevens verzoekt, kan hij of zij op enig moment contact opnemen met een medewerker van de verantwoordelijke. Een medewerker van “%1$s” zorgt er onmiddellijk voor dat aan het verzoek tot wissen onmiddellijk wordt voldaan.
...
Als aan één van de bovengenoemde voorwaarden is voldaan en een betrokkene de beperking van de verwerking van persoonlijke gegevens die is opgeslagen door de website “%1$s” wil aanvragen, kan hij of zij op elk gewenst moment contact opnemen met een medewerker van de controller. De medewerker van de website “%1$s” regelt de beperking van de verwerking.
...
Bovendien heeft de betrokkene bij de uitoefening van zijn recht op gegevensportabiliteit overeenkomstig artikel 20(1) van de AVG het recht persoonsgegevens rechtstreeks van de ene voor de andere naar de andere te laten doorgeven, waar technisch mogelijk is en de rechten en vrijheden van anderen niet nadelig beïnvloedt.
...
Een overzicht van de nationale gegevensbeschermingsautoriteiten en hun links en adressen kan u hier vinden: <a onclick="window.open(this.href); return false;" href="https://ico.org.uk/">https://ico.org.uk/ - adres voor Groot-Brittannië</a> of <a onclick="window.open(this.href); return false;" href="https://ec.europa.eu/newsroom/article29/item-detail.cfm?item_id=612080">https://ec.europa.eu - adressen en links voor Europese landen</a>.

<h3>Gegevensbeschermingsbepalingen betreffende de toepassing en het gebruik van profielfoto’s bij Gravatar</h3>
De controller heeft de Gravatar service op deze website geïntegreerd om de hulp van Gravatar te kunnen gebruiken om postschrijvers en commentenschrijvers de gelegenheid te geven hun berichten te personaliseren met een profielfoto (ook bekend als een avatar). De exploitant van de dienst Gravatar is het Automattic Inc., 132 Hawthorne Street San Francisco, CA 94107, VS.
...
Als de betrokkene tegelijkertijd op Facebook is ingelogd, detecteert Facebook bij elke oproep op onze website door de betrokkene en voor de gehele duur van zijn verblijf op onze website welke specifieke subsite van onze internetpagina werd bezocht door de betrokkene. Deze informatie wordt verzameld via het Facebook onderdeel en gekoppeld aan het respectieve Facebook account van de betrokkene. Als de betrokkene op een van de Facebook knoppen klikt die in onze website zijn geïntegreerd, bijvoorbeeld de "Vind ik leuk" knop, of als de betrokkene een opmerking indient, dan stemt Facebook deze informatie overeen met de persoonlijke Facebook gebruikersaccount van de betrokkene en slaat deze de persoonlijke gegevens op.
...
<h3>Verstrekking van persoonsgegevens als wettelijk of contractueel vereiste; Vereiste noodzakelijk om een contract aan te gaan; Verplichting van de betrokkene om de persoonsgegevens te verstrekken; mogelijke gevolgen van het niet verstrekken van dergelijke gegevens</h3>
...
<h3>Beëindiging van uw contract</h3>
Iedereen op onze website kan op elk moment naar eigen goeddunken zijn registratie verwijderen. Alle persoonlijke gegevens worden verwijderd wanneer de registratie wordt geannuleerd. Na verwijdering kunnen we de gegevens niet herstellen.',
	'JVPPDMT_USED_COOKIE' => array(
		...
		'%1$s_cookie_status: Wanneer u onze website bezoekt, wordt een bevestiging van acceptatie van het gebruik van cookies opgeslagen.',
		...
		'%1$s_u: De gebruikers ID van de gebruiker wordt hier opgeslagen.',
		...
		'<br><strong>Cookies gebruikt door Arcade:</strong>',
		'%1$s_arcade_sid: Bevat de game sessie ID voor gebruik met phpBB Arcade.',
		'%1$s_arcade_pd: Bevat de game ID voor gebruik met phpBB Arcade.',
		'%1$s_arcade_popup: Bevat de instellingen bij het spelen van een game in het pop-up venster.',
		'%1$s_arcade_lighting: Bevat de gebruikersvoorkeur voor achtergrondverlichting voor games.',
		'%1$s_arcade_info_block: Bevat de gebruikersvoorkeur voor de zichtbaarheid van het informatieblok tijdens de spelen.',
		...
		'%1$s_jv_shout_close_: Wordt gebruikt op alle pagina’s waar u het shoutbox blok hebt gesloten. Elke pagina maakt een cookie in zijn eigen naam. De indexpagina heeft bijvoorbeeld de naam: %1$s_jv_shout_close_index.',
	...
	'JVPPDMT_DISABLED_COOKIE_GUEST_USER'	=> 'We hebben geen cookies opgeslagen op apparaten van gast gebruikers!',
	'JVPPDMT_COOKIE_DESC'					=> 'Aandacht! Deze website maakt gebruik van cookies om ervoor te zorgen dat u de beste ervaring op onze website krijgt. <a onclick="window.open(this.href); return false;" href="https://cookiesandyou.com/">Leer meer</a>.<br>Hier heeft u de mogelijkheid om cookies te accepteren of te weigeren, en op elk moment kunt u het gebruik van website cookies in uw browser instellingen uitschakelen.',
	'JVPPDMT_COOKIE_CONFIRM'				=> 'Selecteer of de %s website cookies op uw apparaat kan opslaan:',
	'JVPPDMT_PERSONAL_DATA_REG'				=> 'Aandacht! Tijdens de registratie moeten persoonlijke gegevens worden verstrekt.',
	'JVPPDMT_PERSONAL_DATA_CONFIRM'			=> 'Selecteer of de %s website uw persoonlijke gegevens mag gebruiken en opslaan. De persoonlijke gegevens worden niet doorgegeven aan derden.',
	'JVPPDMT_NOT_CONFIRM'					=> 'Aandacht! U hebt geen selectie gemaakt om te bevestigen.',
	'JVPPDMT_APPROVAL'						=> 'Goedkeuren',
	'JVPPDMT_REJECTION'						=> 'Afkeuren',
	'JVPPDMT_ONLY_REGISTER_DATA'			=> 'Voor de persoonlijke gegevens die vereist zijn voor registratie, keur ik goed, maar verder niets.<br><em>Houd er rekening mee dat als u voor deze optie kiest, u zich in een groep bevindt die alleen in aanmerking komt voor weergave. Uiteraard kunt u deze beslissing later in de gebruikerspaneel/privacygegevens instellingen wijzigen.</em>',
	'JVPPDMT_ONLY_ALREADY_EXISTING_DATA'	=> 'Voor de reeds opgeslagen gegevens keur ik goed, maar verder niets.<br><em>Houd er rekening mee dat als u voor deze optie kiest, u zich in een groep bevindt die alleen in aanmerking komt voor weergave. Uiteraard kunt u deze beslissing later in de gebruikerspaneel/privacygegevens instellingen wijzigen.</em>',
