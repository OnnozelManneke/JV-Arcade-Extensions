...
* @version $Id: logs.php 2368 2020-11-20 21:37:25Z KillBill $
...
$lang = array_merge($lang, array(
	...
	'LOG_ARCADE_FORM_SCORE_ERROR'					=> '<strong>Het spel “%s” heeft een onjuiste score verzonden</strong><br>Opslag type: %s<br>Speeltijd: %s<br>Score: %s<br><strong>Fout:</strong> (%s)',
	'LOG_ARCADE_FORM_SCORE_ERRORS'					=> '<strong>Het spel “%s” heeft een onjuiste score verzonden</strong><br>Opslag type: %s<br>Speeltijd: %s<br>Score: %s<br><strong>Fouten:</strong> (%s)',
	...
	'LOG_ARCADE_SYNC_GAME'							=> '<strong>Spel gesynchroniseerd</strong><br>» %s',
	'LOG_ARCADE_SYNC_GAMES'							=> '<strong>Spellen gesynchroniseerd</strong><br>» %s',
	'LOG_ARCADE_SYSTEM'								=> '<strong>Gewijzigde systeeminstellingen</strong>',
	...
	'LOG_ARCADE_UNPACK_GAME'						=> '<strong>Uitgepakt spel</strong><br>» %s',
	'LOG_ARCADE_UNPACK_GAMES'						=> '<strong>Uitgepakte spellen</strong><br>» %s',
	'LOG_ARCADE_UPLOAD_UNPACK_GAME'					=> '<strong>Geüploade en uitgepakt spel</strong><br>» %s',
	'LOG_ARCADE_USER_BANNED'						=> '<strong>Verbannen gebruiker</strong><br>» %s',
	'LOG_ARCADE_USER_GAME_SETTINGS'					=> '<strong>Gewijzigde spel instellingen</strong>',
	'LOG_ARCADE_USER_MAIN_SETTINGS'					=> '<strong>Gewijzigde hoofd instellingen</strong>',
	'LOG_ARCADE_USER_MANAGE_FAVORITES'				=> '<strong>Beheerde zijn favoriete spellen</strong>',
	...
	'LOG_C_ROLE_EDIT'								=> '<strong>Categorierol aangepast</strong><br>» %s',
