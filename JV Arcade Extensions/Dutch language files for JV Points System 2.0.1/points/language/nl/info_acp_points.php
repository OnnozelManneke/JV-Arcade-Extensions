...
$lang = array_merge($lang, array(
	...
	'JV_ACP_POINTS_GROUPS_CHANGED_SUCCESS'					=> 'Van de “%s” groep alle gebruikers saldo aantal succesvol gewijzigd.',
	...
	'JV_ACP_POINTS_GROUP_CHANGED_SUCCESS'					=> 'Van de “%s” groep alle gebruikers saldo aantal succesvol gewijzigd.',
	...
	'JV_ACP_POINTS_USERS_CHANGED_SUCCESS'					=> 'De  “%s” gebruikers saldo succesvol gewijzigd.',
	'JV_ACP_POINTS_USERS_DEFAULT_GROUPS_CHANGED_SUCCESS'	=> 'De “%s” gebruiker standaard groep het saldo succesvol gewijzigd.',
	'JV_ACP_POINTS_USERS_DEFAULT_GROUP_CHANGED_SUCCESS'		=> 'De “%s” gebruikers standaard groep het saldo succesvol gewijzigd.',
	...
	'JV_LOG_POINTS_ADD_GROUPS'								=> '<strong>Voeg het aantal punten toe voor alle gebruikers in de volgende groepen: %s</strong><br>» Toegevoegde punten: %s',
	'JV_LOG_POINTS_ADD_USER'								=> '<strong>Voeg het aantal punten toe voor de volgende gebruiker: %s</strong><br>» Toegevoegde punten: %s',
	'JV_LOG_POINTS_ADD_USERS'								=> '<strong>Voeg het aantal punten toe voor de volgende gebruikers: %s</strong><br>» Toegevoegde punten: %s',
	'JV_LOG_POINTS_ADD_USERS_DEFAULT_GROUP'					=> '<strong>Voeg het aantal punten toe voor de standaard gebruiker in de volgende groep: %s</strong><br>» Toegevoegde punten: %s',
	'JV_LOG_POINTS_ADD_USERS_DEFAULT_GROUPS'				=> '<strong>Voeg het aantal punten toe voor de standaard gebruikers in de volgende groepen: %s</strong><br>» Toegevoegde punten: %s',
