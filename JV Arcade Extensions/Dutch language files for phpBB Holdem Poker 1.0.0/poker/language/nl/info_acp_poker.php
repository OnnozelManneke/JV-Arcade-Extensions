...
$lang = array_merge($lang, array(
	...
	'ACP_JV_POKER_EXT_NAME_JV_PS'					=> 'JV Points System',
	'ACP_JV_POKER_EXT_NAME_ULTIMATE_PS'				=> 'Ultimate Points Extension',
	'ACP_JV_POKER_INSTALL_EXT_DETECT_DISABLED'		=> 'The phpBB Holdem Poker has detected you have the <strong>“%s”</strong> installed and disabled.',
	'ACP_JV_POKER_INSTALL_EXT_DETECT_ENABLED'		=> 'The phpBB Holdem Poker has detected you have the <strong>“%s”</strong> installed and enabled.',
	...
	'ACP_JV_POKER_MAIN'								=> 'phpBB Holdem Poker - Main',
	'ACP_JV_POKER_MAIN_INDEX'						=> 'Welcome page',
	'ACP_JV_POKER_MAIN_TITLE'						=> 'Welcome to phpBB Holdem Poker!',
	'ACP_JV_POKER_MAIN_TITLE_EXPLAIN'				=> 'Thank you for choosing phpBB Holdem Poker as your poker solution. This screen will give you a quick overview of all the various statistics of your poker. The links on the left hand side of this screen allow you to control every aspect of your poker experience. Each page will have instructions on how to use the tools.',
	'ACP_JV_POKER_MANAGE'							=> 'phpBB Holdem Poker - Manage',
	...
	'ACP_JV_POKER_ROOM_AUTO_RESIZE'					=> 'Room auto resizing',
	'ACP_JV_POKER_ROOM_AUTO_RESIZE_EXPLAIN'			=> 'If enable, the room will be automatically adjusted to the size of that window.',
	...
	'ACP_JV_POKER_SETTINGS'							=> 'phpBB Holdem Poker - settings',
	'ACP_JV_POKER_SETTINGS_GAME'					=> 'Game settings',
	'ACP_JV_POKER_SETTINGS_GENERAL'					=> 'General settings',
	'ACP_JV_POKER_SETTINGS_GENERAL_EXPLAIN'			=> 'Configure various settings for phpBB Holdem Poker',
	...
	'ACP_JV_POKER_STATS'							=> 'Poker Statistics',
...
<strong>phpBB Holdem Poker version number:</strong> %7$s<br><br>
<strong style="color: #BC2A4D;">We declare that user activity will not be tracked and that no personal data about registered users of your forum will be stored or collected on “%8$s”!</strong>',
	...
	'ACP_JV_POKER_VERSION_CHECK_TITLE'				=> 'phpBB Holdem Poker - version check',
	'ACP_JV_POKER_VERSION_CHECK_TITLE_EXPLAIN'		=> 'Checks to see if your phpBB Holdem Poker installation is up to date.',
	...
	'LOG_JV_POKER_RADIO_ADD'						=> '<strong>phpBB Holdem Poker - Create a radio station</strong><br>» Radio: %s',
	'LOG_JV_POKER_RADIO_DELETE'						=> '<strong>phpBB Holdem Poker - Delete radio station</strong><br>» Radio: %s',
	'LOG_JV_POKER_RADIO_EDIT'						=> '<strong>phpBB Holdem Poker - Edit radio station</strong><br>» Radio: %s',
	'LOG_JV_POKER_ROOM_ADD'							=> '<strong>phpBB Holdem Poker - Create room</strong><br>» Room: %s',
	'LOG_JV_POKER_ROOM_DELETE'						=> '<strong>phpBB Holdem Poker - Delete room</strong><br>» Room: %s',
	'LOG_JV_POKER_ROOM_EDIT'						=> '<strong>phpBB Holdem Poker - Edit room</strong><br>» Room: %s',
	'LOG_JV_POKER_SETTINGS'							=> '<strong>phpBB Holdem Poker - Altered settings</strong>',
	'LOG_JV_POKER_USERS_RESET'						=> '<strong>phpBB Holdem Poker - Reset users data</strong>',
	'LOG_JV_POKER_VERSION_CHECK_DISABLED'			=> '<strong>phpBB Holdem Poker - Automatic version check disabled</strong>',
	'LOG_JV_POKER_VERSION_CHECK_ENABLED'			=> '<strong>phpBB Holdem Poker - Automatic version check enabled</strong>',
));
