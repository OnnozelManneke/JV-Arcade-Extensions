...
$lang = array_merge($lang, array(
	...
	'JVA_GAME_INTRO_GAME_PRELOAD_EXPLAIN'	=> 'Het (de) kernbestand(en) van het spel wordt alleen in de browsercache geladen. Als het niet is ingeschakeld voor de cache van uw browser, worden de bestanden twee keer geladen, dus deze methode kan de start van de games alleen maar vertragen.<br><em>Het gebruik van de browsercache wordt ten zeerste aanbevolen voor alle gebruikers!</em>',
