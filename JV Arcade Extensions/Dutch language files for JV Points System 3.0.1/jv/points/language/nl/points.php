...
$lang = array_merge($lang, array(
	...
	'JV_POINTS_NOTIFICATION_CHANGE_ADD'		=> 'Gebruiker %s heeft saldo aan uw account toegevoegd.<br>Toegevoegd bedrag: %s.',
	'JV_POINTS_NOTIFICATION_CHANGE_SUB'		=> 'Gebruiker %s afgetrokken saldo van uw account.<br>Afgetrokken bedrag: %s.',
	'JV_POINTS_NOTIFICATION_TRANSFER'		=> 'Gebruiker %s heeft %s aan u gedoneerd.',
