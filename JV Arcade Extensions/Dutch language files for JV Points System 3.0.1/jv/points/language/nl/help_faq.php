...
* @version $Id: help_faq.php 461 2018-12-06 11:10:46Z Scanialady $
...
// step 1
	...
	'JV_POINTS_HELP_FAQ_INTRO_MODULES_ANSWER'				=> 'In het puntensysteem zijn veel modules opgenomen, maar alleen degene die geactiveerd zijn door de beheerder zijn beschikbaar. 
																...
																<ul>
																	...
																	<li><strong>Overdracht</strong> - Hier kunt u saldo naar een andere gebruiker overzetten.</li>
																	<li><strong>Overdracht logs</strong> - Hier kunt u de overdrachtstransacties zien.</li>
...
// step 2
	...
	'JV_POINTS_HELP_FAQ_GENERAL_TRANSFER_COST_ANSWER'		=> 'Ja, maar alleen als de beheerder bepaalde kosten moet opgeven. De kosten kunnen een bepaald percentage van het bedrag zijn dat moet worden overgemaakt.',
	'JV_POINTS_HELP_FAQ_GENERAL_TRANSFER_COST_QUESTION'		=> 'Wordt de overdracht koste wat kost aangerekend?',

	'JV_POINTS_HELP_FAQ_GENERAL_TRANSFER_LOG_ANSWER'		=> 'Ja, elke overdracht heeft een logboek invoer die kan worden bekeken in het overdracht log.',
	'JV_POINTS_HELP_FAQ_GENERAL_TRANSFER_LOG_QUESTION'		=> 'De overdrachten kunnen worden getraceerd?',

	'JV_POINTS_HELP_FAQ_GENERAL_TRANSFER_ELOG_ANSWER'		=> 'Als u geen logboek vermeldingen ziet, heeft een beheerder dit verwijderd.',
	'JV_POINTS_HELP_FAQ_GENERAL_TRANSFER_ELOG_QUESTION'		=> 'Mijn logboek vermeldingen zijn verdwenen, waarom??',
));
