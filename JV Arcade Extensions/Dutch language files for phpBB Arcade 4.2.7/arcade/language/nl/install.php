...
* @version $Id: install.php 1883 2018-03-01 12:23:03Z Froddelaar $
...
$lang = array_merge($lang, array(
	'INSTALL_ARCADE_ALL_FOUND'							=> 'Allen gevonden',
	...
	'INSTALL_ARCADE_VERIFY_DB_CONFIGS'					=> 'Controleer configs',
	...
	'INS_ARCADE_CONVERT_GAME_INSTALL_FILE_EXPLAIN'		=> 'Hier onder kun je zien hoe ver het staat met het omzetting proces, sluit de browser NIET aan het einde van het proces.',
	...
	'INS_ARCADE_DELETE_DUPLICATE_GAME'					=> 'Dubbel spel verwijderd',
	'INS_ARCADE_DELETE_DUPLICATE_GAMES'					=> 'Dubbele spellen verwijderd',
	...
	'INS_ARCADE_UND_GAMES_FILESIZE'						=> 'Ongespecificeerde bestand grootte, spellen',
	'INS_ARCADE_UND_GAMES_WIDTH_HEIGHT'					=> 'Ongespecificeerde spel hoogte en breedte, spellen',
	'INS_ARCADE_UPDATE_GAME_DATA'						=> 'Update spel gegevens',
	'INS_ARCADE_UPDATE_GAME_DATA_END'					=> 'Het bijwerking proces is klaar, je kunt de resultaten hier beneden zien.',
	'INS_ARCADE_UPDATE_GAME_DATA_EXPLAIN'				=> 'Het upgrade proces zal de correcte grootte van de spellen instellen: (Spel totaal bestandsgrootte, hoogte en breedte). Als deze data niet correct in het installatie bestand staat of in de database, zal het bijgewerkt worden naar de correcte data.<br><span style="color: #ff0000;">Waarschuwing:</span> Let op, dat tijdens het proces sommige grote spellen heel wat geheugen gebruiken, het kan dus zijn dat het proces daarom niet doorgaat of kan plaats vinden, in dit geval is het raadzaam de server geheugen limiet te verhogen in het php.ini bestand.',
	'INS_ARCADE_UPDATE_GAME_DATA_PROC_EXPLAIN'			=> 'Hier onder kun je zien hoever het bijwerking proces is gevorderd, let op, sluit je browser NIET gedurende dit proces, sluit het pas als het klaar is',
));
