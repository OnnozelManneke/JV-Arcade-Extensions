...
* @version $Id: help_user.php 1881 2018-02-28 20:36:05Z killbill $
...
// step 2
	...
	'ARCADE_HELP_FAQ_GENERAL_GAME_BUG_ANSWER'			=> 'Als eerste wacht even een moment. Sommige spellen, hebben door hun grootte, meer tijd nodig om te laden. Een corrupt spel moet worden gemeld aan de beheerder zodat hij het probleem zo snel mogelijk kan oplossen. Elk spel bevat een link naar een fout bericht. Gebruik deze link om de fout te melden, dit omdat deze link alle specifieke informatie bevat over het spel wat belangrijk is voor ons, ook kunt u dan kiezen wat voor soort probleem opgetreden is. Een meer uitgebreide fout beschrijving is wenselijk. Laat ons aub ook weten welk type browser en welke versie werd gebruikt, omdat het niet zeker is dat deze fout ook op treedt in andere browsers.',
...
// step 4
	...
	'ARCADE_HELP_FAQ_PLAYING_FULL_SCREEN_QUESTION'		=> 'Kan ik een spel spelen in volledig scherm?',
	
	'ARCADE_HELP_FAQ_PLAYING_MOBILE_ANSWER'				=> 'Ja, maar in de meeste gevallen werken alleen Html5-games op mobiele apparaten.',
	'ARCADE_HELP_FAQ_PLAYING_MOBILE_QUESTION'			=> 'Kan ik op een mobiele telefoon spelen?',	

	'ARCADE_HELP_FAQ_PLAYING_BACKLIGHT_ANSWER'			=> 'De achtergrondverlichting heeft twee nuttige eigenschappen:
															<ul>
...
// step 6
	'ARCADE_HELP_FAQ_SEARCH_GAME_ANSWER'				=> 'Als de zoek functie is geactiveerd, zie je een zoek box ongeveer in het midden van de pagina, waar je de naam van het spel kan ingeven. Tijdens de zoekopdracht wordt rekening gehouden met de spel omschrijvingen, dus als dat woord in een spel omschrijving voor komt dan zal dat spel verschijnen.',
