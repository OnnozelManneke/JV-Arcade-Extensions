...
* @version $Id: help_developer.php 1892 2018-03-01 16:06:37Z Froddelaar $
...
// step 1
	'ARCADE_ACP_HELP_FAQ_GENERAL_FEATURES_ANSWER'		=> '<ul>
																...
																<li>Ongelimiteerde categorieën, sub-categorieën and linken (bootst phpBB3 forums na)</li>
																<li>Volledige ACP, MCP and UCP modules</li>
	...
	'ARCADE_ACP_HELP_FAQ_GENERAL_STYLES_ANSWER'			=> '<ul>
																...
																<li>Als je een nieuwe stijl hebt, deel deze dan met ons: <b><a onclick="window.open(this.href); return false;" href="https://jv-arcade.com/phpBB_Arcade_User_Styles.html">HERE</a></b>.</li>
															</ul>',
...
// step 2
	...
	'ARCADE_ACP_HELP_FAQ_INSTALL_INSTALL_ANSWER'		=> '<ul>
																<li>Download de laatste versie en pak ze uit.</li>
																<li>Kopieer de bestanden naar je server in de forum „[ROOT]/” directory terwijl u de structuur van de folders behoud.</li>
																<li>Ga naar het beheerderspaneel en klik op de „Aanpassingen” tab. Klik daar op de phpBB Arcade „Inschakelen” link om de phpBB arcade te installeren.</li>
															</ul>',
	...
	'ARCADE_ACP_HELP_FAQ_INSTALL_UPDATE_ANSWER'			=> '<ul>
																<li>Download de laatste versie en pak ze uit.</li>
																<li>Kopieer de bestanden naar je server in de forum „[ROOT]/” directory terwijl u de structuur van de folders behoud.</li>
																<li>Ga naar het beheerderspaneel en klik op de „Aanpassingen” tab. Klik daar op de phpBB Arcade „Uitschakelen” link. Klik nu op de phpBb Arcade „Inschakelen” en je phpBB Arcade is geüpdatet.</li>
															</ul>',
	'ARCADE_ACP_HELP_FAQ_INSTALL_UPDATE_QUESTION'		=> 'Hoe update ik de phpBB Arcade?',

	'ARCADE_ACP_HELP_FAQ_INSTALL_UNINSTALL_ANSWER'		=> 'Ga naar het beheerderspaneel en klik op de „Aanpassingen” tab. Klik daar op de de phpBB „Uitschakelen” link. Klik dan op de „Verwijder data” link. Verwijder daarna alle phpBB Arcade bestanden van je server.',
...
// step 4
	...
	'ARCADE_ACP_HELP_FAQ_GAMES_REQ_INSTALL_ANSWER'		=> 'Spellen die je zelf samenstelt moeten geüpload worden naar de (standaard) <strong>[ROOT]/arcade/games/</strong> in een folder dat dezelfde naam heeft als de swf bestandsnaam. Indien het flash bestand <strong>test.swf</strong> noemt, zal in de <strong>[ROOT]/arcade/games/</strong> een folder zitten genaamd <strong>test</strong>.<br><br>In deze folder zitten:<br><ul><li>test.swf (flash)</li><li>test.gif (50px x 50px)</li><li>test.php (Installatie bestand, indien niet aanwezig zal het spel niet installeren)</li><li>index.htm (leeg html bestand)</li></ul>',
	'ARCADE_ACP_HELP_FAQ_GAMES_REQ_INSTALL_QUESTION'	=> 'Wat is er nodig om een spel te installeren?',

	'ARCADE_ACP_HELP_FAQ_GAMES_HOW_INSTALL_ANSWER'		=> 'Er zijn 3 manieren om een spel te installeren<br>
															<ul>
																<li>Indien je het spel download door middel van het phpBB Arcade ingebouwde download systeem zal een gecomprimeerde folder aangeboden worden die je kan uploaden via FTP naar <strong>[ROOT]/arcade/install/</strong> en kan installeren via het beheerderspaneel.</li>
																<li>Indien je het spel download door middel van het phpBB Arcade ingebouwde download systeem zal een gecomprimeerde folder aangeboden worden die je kan uploaden via de beheerderspaneel Spellen uploaden/uitpakken module. Eenmaal geüpload zal het spel automatisch uitgepakt worden, en zal je de mogelijkheid hebben om het spel toe te voegen aan de arcade</li>
																<li>Een andere optie is om het spel te uploaden naar de correcte locatie op de server, en dan via het beheerderspaneel het spel te installeren.</li>
															</ul>',
	'ARCADE_ACP_HELP_FAQ_GAMES_HOW_INSTALL_QUESTION'	=> 'Hoe kan ik een spel installeren?',

	'ARCADE_ACP_HELP_FAQ_GAMES_ZIP_ANSWER'				=> 'Ja, het proces is heel makkelijk. Alles wat je hoeft te doen is een folder maken met dezelfde naam als het .swf bestand, en in die folder plaats je ook de spelnaam.swf, spelnaam.gif, spelnaam.php en index.htm bestanden.',
...
*	V3Arcade, IBProV32, phpBB Arcade, Arcade room en spellen die geen scores verzenden)
...
// step 5
	'ARCADE_ACP_HELP_FAQ_MODULES_ANSWER'				=> '<strong><br>De Arcade heeft de onderstaande ACP Modules:<br></strong>
															<strong>Configuratie</strong><br>
															<ul>
																<li><strong>Algemene instellingen</strong> - Beheer de algemene instellingen voor de arcade.</li>
																<li><strong>Extensies instellingen</strong> - Beheer extensie instellingen voor de arcade.</li>
																...
																<li><strong>Toernooi instellingen</strong> - Beheer toernooi instellingen voor de arcade.</li>
																<li><strong>Functie instellingen</strong> - Beheer de functie instellingen voor de arcade.</li>
																<li><strong>Arcade pagina-instellingen</strong> - Beheer de pagina instellingen voor de arcade.</li>
																<li><strong>Uitdaging pagina instellingen</strong> - Beheer de pagina instellingen voor de uitdagingen.</li>
																<li><strong>Toernooi pagina instellingen</strong> - Beheer de pagina instellingen de toernooien.</li>
															...
															<ul>
																...
																<li><strong>Gebande gebruiker</strong> - Bekijk gebande gebruikers/ ontban ze</li>
