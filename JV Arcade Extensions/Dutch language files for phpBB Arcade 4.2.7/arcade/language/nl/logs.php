...
* @version $Id: logs.php 1885 2018-03-01 14:24:50Z Froddelaar $
...
$lang = array_merge($lang, array(
	...
	'LOG_ARCADE_ADD_GAME'							=> '<strong>Spel toegevoegd van %s categorie.</strong><br>» %s',
	'LOG_ARCADE_ADD_GAMES'							=> '<strong>Spellen toegevoegd van %s categorie.</strong><br>» %s',
	...
	'LOG_ARCADE_APAGE'								=> '<strong>Pagina instellingen gewijzigd </strong>',
	...
	'LOG_ARCADE_BACKUP_CAT'							=> '<strong>Back up gemaakt van categorie</strong><br>» %s',
	'LOG_ARCADE_BACKUP_CATS'						=> '<strong>Back up gemaakt van categorieën</strong><br>» %s',
	'LOG_ARCADE_BACKUP_EMPTY'						=> '<strong>Back-up folder geledigd</strong>',
	...
	'LOG_ARCADE_CLEAR_CRITICAL_LOG'					=> '<strong>Error opgeschoond</strong>',
	...
	'LOG_ARCADE_CPAGE'								=> '<strong>Wedstrijd pagina instellingen gewijzigd</strong>',
	...
	'LOG_ARCADE_FORM_SCORE_ERROR'					=> '<strong>Het spel “%s” heeft een niet juiste score verzonden</strong><br>Type: %s<br>Score: %s<br><strong>Error:</strong> (%s)',
	'LOG_ARCADE_FORM_SCORE_ERRORS'					=> '<strong>Het spel “%s” heeft een niet juiste score verzonden</strong><br>Type: %s<br>Score: %s<br><strong>Errors:</strong> (%s)',
	...
	'LOG_ARCADE_GAME_ANNOUNCE_SYNC'					=> '<strong>Re-synchroniseer spel mededelingen</strong>',
	'LOG_ARCADE_GAME_DATA_EMPTY_ERROR'				=> '<strong>Het spel “%s” heeft geen arcadegid of enscore code verzonden. Het spel is corrupt.</strong><br>» Score: %s',
	'LOG_ARCADE_GAME_FILE_NOT_FOUND'				=> '<strong>Een file van spel “%s” kan niet gevonden worden</strong><br>» File: %s',
	...
	'LOG_ARCADE_MENUS_DELETE'						=> '<strong>Verwijderde menu en zijn submenus </strong><br>» %s',
	...
	'LOG_ARCADE_RESTORE_DEFAULT_DATA_PM'			=> '<strong>Prive berichten standaard gegevens hersteld/strong><br>» %s',
	'LOG_ARCADE_RESYNC_TOTALS_DATA'					=> '<strong>Totale data geresynchronizeerd</strong>',
	...
	'LOG_ARCADE_TOURNAMENT'							=> '<strong>Toernooi instellingen aaangepast</strong>',
	...
	'LOG_ARCADE_TPAGE'								=> '<strong>Gewijzigd toernooi pagina instellingen</strong>',
	...
	'LOG_ARCADE_USER_SET_UPDATE'					=> '<strong>Geupdate gebruiker details</strong><br>» %s',
