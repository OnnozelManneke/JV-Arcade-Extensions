...
$lang = array_merge($lang, array(
	...
	'ARCADE_ACP_HELP_FAQ_DATA_EXT_ANSWER'				=> 'Ja, er is een add-on voor phpBB Arcade - zie <a onclick="window.open(this.href); return false;" href="https://jv-arcade.com/phpBB_Arcade_Extensions.html">Add-ons</a>',
	'ARCADE_ACP_HELP_FAQ_DATA_EXT_QUESTION'				=> 'Zijn er add-ons? ',
	'ARCADE_ACP_HELP_FAQ_GAMES_DELETE_ANSWER'			=> 'Om een ​​spel te verwijderen, klikt u op de Beheerderspaneel module „Beheer categorieën” of „Beheer spellen” en selecteert u het die u wilt verwijderen. Hier kun je het verwijderen van de bestanden van de server bevestigen, gebruik dit alleen als je het spel permanent wilt verwijderen en later niet opnieuw wilt installeren.',
...
*
*	Parameters moeten worden ingesteld voor games
*	te installeren.
*	De opgegeven parameters worden opgeslagen in de spelkamer database.
*
