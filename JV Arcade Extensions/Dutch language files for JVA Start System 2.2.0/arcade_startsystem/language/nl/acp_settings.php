...
$lang = array_merge($lang, array(
    'JVA_GAME_DANGEROUS_DISABLE'            => 'Gevaarlijke spellen uitgeschakeld',
    'JVA_GAME_DANGEROUS_DISABLE_EXPLAIN'    => 'Sommige spellen kunnen de goede werking van de server in gevaar brengen, omdat ze gegevens op de achtergrond overbrengen en de webpagina meerdere keren opnieuw laden. Dit verhoogt de belasting van de server enorm, en dergelijke spellen worden automatisch uitgeschakeld vanwege de veiligheid. Hier heeft u echter de mogelijkheid om deze automatische blokkeerfunctie op eigen risico uit te schakelen.',	
	...
	'JVA_GAME_INTRO_GAME_PRELOAD_EXPLAIN'	=> 'Het (de) kernbestand(en) van het spel wordt alleen in de browsercache geladen. Als het niet is ingeschakeld voor de cache van uw browser, worden de bestanden twee keer geladen, dus deze methode kan de start van de spellen alleen maar vertragen.<br><em>Het gebruik van de browsercache wordt ten zeerste aanbevolen voor alle gebruikers!</em>',
    ...
    'JVA_GAME_INTRO_MUSIC'                  => 'Muziek inschakelen',
    'JVA_GAME_INTRO_MUSIC_EXPLAIN'          => 'U kunt hier het afspelen van muziek voor de spel intro in of uitschakelen. Muziek wordt willekeurig geladen uit bestanden 1-3. Je kunt muziekbestanden op elk moment vervangen, maar houd de bestandsnamen en de twee basisformaten beschikbaar (ogg en mp3).',
	'JVA_GAME_INTRO_MUSIC_FLD'				=> 'Muziek type',
	'JVA_GAME_INTRO_MUSIC_FLD_DEFAULT'		=> 'Standaard',
	'JVA_GAME_INTRO_MUSIC_FLD_GAME'			=> 'Spel',
	'JVA_GAME_INTRO_MUSIC_FLD_CHRISTMAS'	=> 'Kerstmis',
	'JVA_GAME_INTRO_PRIVATE_SETTINGS'		=> 'De “alle instellingen“ zijn alleen beschikbaar als de oprichter “JVA Start Systeem“ heeft geactiveerd met een privésleutel.',
